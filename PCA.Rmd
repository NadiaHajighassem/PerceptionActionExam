...
num_pca_components_to_use <- 1  # You can adjust this as needed
...
## Scree plots 
```{r}
g <- list_of_dataframes$group1_jointlead # You can change groups here 
...
save_component_list_as_csv(pca_components_list_A, "results/PCA", "component_A")
save_component_list_as_csv(pca_components_list_B, "results/PCA", "component_B")

# Print a message to indicate completion
cat("All components have been saved as CSV in the 'results/PCA' directory.\n")

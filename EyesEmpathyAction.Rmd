...
```{r motion_data}
synchrony_scores_PCA <- read_csv("results/dtw_results_df_PCA.csv")
synchrony_scores_ICA <- read_csv("results/dtw_results_PCA.csv") #PLACEHOLDER!!!!!
```
...
synchrony_scores_PCA %>%
  ggplot(aes(x=Mean_DTW_Distance)) +
  geom_density(fill = global_fill_colour, alpha=0.7) +
    xlim(0, 300) +

...
## OLD: Scoring each pair (One component)
...
Results can be found in dtw_results_df_PCA
...
for (i in seq_along(component_list_A)) {
  ...
  # Divide the summed DTW distance by 2 
...
A <- component_list_A[["group3_jointlead_A"]]
B <- component_list_B[["group3_jointlead_B"]]
...
### NEW: Visualising all pairs first principal component in twoway, threeway and density plots:
...
dir.create("results/DTW_twowayPlots", showWarnings = FALSE)
...
for (i in seq_along(component_list_A)) {
    ...
    # Open the PNG device
    png(file = paste0("results/DTW_twowayPlots/", gsub(" ", "_", plot_title), ".png"))
...
# Create a folder to save plots
dir.create("results/DTW_threewayPlots", showWarnings = FALSE)
...
for (i in seq_along(component_list_A)) {
    ...
    # Open the PNG device
    png(file = paste0("results/DTW_threewayPlots/", gsub(" ", "_", plot_title), ".png"))
...
# Create a folder to save plots
dir.create("results/DTW_densityPlots", showWarnings = FALSE)
...
for (i in seq_along(component_list_A)) {
    ...
    # Open the PNG device
    png(file = paste0("results/DTW_densityPlots/", gsub(" ", "_", plot_title), ".png"))
